...
class MovieTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        */        
        ...
        Movie::create(['title'=>'¿Quiénes son los Miller?',
        ...
        Movie::create(['title'=>'Happy Gilmore',
                       'release_date'=>'1996-10-10',
                       'release_year'=>1996,
                       'duration'=>92,
                       'image'=>'https://www.descargatelocorp.com/wp-content/uploads/2020/06/Happy-Gilmore-HD-1080p-Latino-1996.jpg.webp',
                       'synopsis'=>'Happy Gilmore era un entusiasta jugador de hockey y ahora no tiene objetivos en su vida. Cuando su novia le abandona y a su madre la echan del piso en el que vive por no abonar el alquiler, decide dedicarse a jugar al golf en campeonatos profesionales con la esperanza de reunir el suficiente dinero para mudar su situación.',
                       'classification'=>'B',
                       'gender_id'=>1]);                                                                     
        ...
        */        
        ...
        Movie::create(['title'=>'No te lo Vas a Creer',
                       'release_date'=>'2019-12-21',
                       'release_year'=>2019,
                       'duration'=>90,
                       'image'=>'https://www.descargatelocorp.com/wp-content/uploads/2020/10/No-te-lo-Vas-a-Creer-2019-HD-1080p-Latino.jpg.webp',
                       'synopsis'=>'Emma Corrigan es una mujer joven, con una relación estable, mas hastiada, con el hombre “perfecto”, y que en nuestros días trata de subir en la escalera corporativa de Panther Cola, una compañía multinacional de bebidas con sede en la ciudad de Londres. En un viaje de negocios, pensando que el aeroplano en el que va está a puntito de estrellarse, Emma le cuenta sus secretos y verdaderas frustraciones a un desconcertado extraño que va sentado junto a ella.',
                       'classification'=>'A',
                       'gender_id'=>2]);                                                                         
